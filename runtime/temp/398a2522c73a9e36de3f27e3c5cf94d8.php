    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?php echo url('Category/insert'); ?>" method="post"  id="form" enctype="multipart/form-data" >
                    <ul class="admin_tab">
