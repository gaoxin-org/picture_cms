<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/Users/sunxuegao/dev_soft/www/picture_cms/application/index/view/tag/tag.html";i:1483977174;s:83:"/Users/sunxuegao/dev_soft/www/picture_cms/application/index/view/public/header.html";i:1484458172;s:83:"/Users/sunxuegao/dev_soft/www/picture_cms/application/index/view/public/footer.html";i:1484459568;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
    ...
    <div class="web">
        <div class="wwimpor">
            ...
            <a href="<?php echo $vo['url']; ?>">
                <dl class="clearfix">
                    <dt class="col-xs-12 col-sm-27">
                        <img src="<?php echo $vo['thumb']; ?>" /></dt>
                    <dd class="col-xs-12 col-sm-73">
                        <div class="wwimporword">
                            <h3><?php echo $vo['title']; ?></h3>
                            <p><?php echo $vo['description']; ?></p>
                            <span>查看详情</span>
                        </div>
                        <div class="wwnewstime">
                            <span><?php echo date("d",$vo['inputtime']); ?></span>
                            <p><?php echo date("Y-m",$vo['inputtime']); ?></p>
                        </div>
                    </dd>
                </dl>
            </a>
